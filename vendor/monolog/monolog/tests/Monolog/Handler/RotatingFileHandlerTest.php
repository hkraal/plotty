...
class RotatingFileHandlerTest extends TestCase
{
    ...
    public function testAllowOnlyFixedDefinedDateFormats($dateFormat, $valid)
    {
        ...
        $handler->setFilenameFormat('{filename}-{date}', $dateFormat);
        if (! $valid) {
            $this->assertErrorWasTriggered(E_USER_DEPRECATED, 'Invalid date format - format should be one of ' . 'RotatingFileHandler::FILE_PER_DAY, RotatingFileHandler::FILE_PER_MONTH ' . 'or RotatingFileHandler::FILE_PER_YEAR.');
        }
    }
